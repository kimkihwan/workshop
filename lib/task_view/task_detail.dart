            ...
            itemBuilder: (BuildContext context) {
              return edits.map((String value) {
                return PopupMenuItem<String>(
                  value: value,
                  child: Text(value, style: TextStyle(color: value=="삭제"?Colors.red:Colors.white),),
                );
              }).toList();
            },
          ),
                  ...
                  return ListTile(
                    title: 
                      Padding(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(replys[index].name, style: TextStyle(fontSize: 14, color: Colors.black, fontWeight: FontWeight.bold)),
                            SizedBox(height: 5),
                            Text(replys[index].text, style: TextStyle(fontSize: 12, color: Colors.black)),
                            SizedBox(height: 5),
