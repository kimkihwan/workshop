...
class _MyAppState extends State<VoiceRecordWidget> {
        ...
        body: ListView(
          children: <Widget>[
            ...
            Container(
              height: 30,
              child: IconButton(
                icon: Icon(Icons.save_alt, color: Colors.black, size: 50),
                onPressed: () => Navigator.of(context).pop(widget.localFileSystem.file(_path[_codec.index])),
              ),
            )
           ],
        ),
